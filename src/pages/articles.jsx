...
function Articles() {
  ...
  const handleBoxClick = (title, summary) => {
    setPopupContent({ title, summary });
    setShowPopup(true);
  };
  ...
  return (
    <div className="Article">
      <div className="Title">
        <h1><b> Articles of ITBMUN 2023 </b></h1>
      </div>
        ...
        Regardless of the divide in the council, it has been established that they are unified in their goal, the approaches still vary. In spite of the contrast in strategy, the five permanent members of UNSC have stated that none of them will be using their veto powers.
        ...
        `)}>
          <h1 className="title">China's Lenient Approach Leads to Variability</h1>
          <p className="summary">
            The delegate of China is open to compromise, which has resulted in an
        ...
        `Bandung, The United Nations Human Rights came close to a conclusion this Saturday in the completion of their 2 working papers which have both been recognized by the council. These hardworking delegates are nearing their last committee session.
        ...
        France, Sweden, and multiple other countries expressed their utmost condolences for the disappearances, and Denmark invited the council to a moment of silence for said victims and their families.
        ...
        <div className="box" onClick={() => handleBoxClick("Protecting the Right Rights",
        `A delegate of Turkey accused Denmark of discriminating against Muslims for banning full face garments in colleges and airports in a UN committee. Seeing as this ban reduces dishonesty and protects the rights of others however, the justness of this ban is taken into question.
        ...
        Perhaps it is derogatory and discriminative to take precautions against a group of people, or it might simply be the human nature of pattern recognition. If some laws created are offensive to some religions, do their rights to be offended trump a writer's right to give his opinion, or a government’s rights to protect its nation? As the United Nations Human Rights council committee progresses we will learn more of the conclusions to these questions. In the next few hours,the committee will soon be taking steps to agree on a specific resolution.`)}>
          <h1 className="title">Protecting the Right Rights</h1>
          <p className="summary">
        ...
        <div className="box" onClick={() => handleBoxClick("How CST Abolishing Member States Turned Into a Room of Cultural Molestors",
        `"We need to educate people on their cultural norms, and that’s bad," the delegate of Norway declared as the entire council swung their heads in agreement.
        ...
        If this ignorance continues to prevail, eventual loopholes will occur during the resolution. What could come is separatism and the marginalisation of communities deemed "backward" by the public and the UN. Education should be used not to change someone but to help them adapt. Take this opportunity to reconsider which side you’re on. The side of the impoverished, who have known underage sex as a crevice of their ancestral history, or the foreign tourists, the ones who know much better yet exploit and trigger demand for the sake of their own pleasure.`)}>
          <h1 className="title">
            How CST Abolishing Member States Turned Into a Room of Cultural
            Molestors
          </h1>
          <div className="meta-data">
        ...
        <div className="box" onClick={() => handleBoxClick("Opinion: Decriminalization of sex work to reduce child sex exploitation", 
        `(CNN)-- ILO estimated that roughly 1.2 up to 2 million juveniles are affected by child sexual exploitation, human trafficking, and child sex tourism each year. The biggest case is in Cambodia where in 2005, 800.000 of sex workers were minors. Other than South East Asia, the problem is prevalent in areas where traveling is cheap.
        ...
        Realistically, how could we prevent child sexual exploitation from happening? Well, some argued for harsher penalties and better supervision. Others also argued for education and by raising awareness. But there is one solution that hasn’t been discussed at all, the decriminalization of sex work.
        ...
        However, can such solutions be actively done by all the nations in the world? And can all the nations do decriminalization as well as New Zealand? Realistically, an absolute no, especially when we are living in a world which consists of different moral standards. However, with some countries already doing either one of the solutions, it shows that it can be done. And in the case of New Zealand, a model and guideline to practically solve the problem. It’s just the question of how many other countries will follow suit?`)}>
          <h1 className="title">
          Opinion: Decriminalization of sex work to reduce child sex
            exploitation
          </h1>
          <p className="summary">
            Protection of sex workers may lead into better enforcement against
        ...
        <div className="box" onClick={() => handleBoxClick("Norway and USA Sets Priorities Straight in Combating Child Sex Tourism Worldwide", 
        `With the leadership of the delegation of Norway and the USA, the United Nation Office on Drugs and Crime has shifted their focus towards combating child sex tourism worldwide in a steady direction.
        ...
        Though Norway’s and USA’s contribution towards the United Nation Office on Drugs and Crime has set the council on a steady path to a unified resolution, it is mandatory for everyone to address the reintegration of victims to society, victim care and protection, and prevention.`)}>
          <h1 className="title">
            Norway and USA Sets Priorities Straight in Combating Child Sex Tourism
            Worldwide
          </h1>
          <p className="summary">
            The Delegates of Norway and USA Untangle the Jumble of Topics in UNODC
